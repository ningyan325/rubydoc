...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2019-01-02T21:05:35.798Z[GMT]")public abstract class ServicesApiService {
    ...
    public abstract Response uploadFile(DocumentCollaborators body,File userId, @NotNull File campaignId,BigDecimal documentId, List<String> versions,SecurityContext securityContext) throws NotFoundException;
}
